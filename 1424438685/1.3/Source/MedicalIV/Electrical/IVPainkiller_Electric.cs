...
{
    public class IVPainkiller_Electric : IVBase
    {
        public IVPainkiller_Electric() : base("Electrical Painkiller", FuelType.ELECTRICITY, new List<HediffDef> { HediffDef.Named("IV_Painkiller") }, 0f) {
        }
